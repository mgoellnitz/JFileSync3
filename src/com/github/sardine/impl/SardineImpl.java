...
public class SardineImpl implements Sardine {
    ...
    /**
     * Local context with authentication cache. Make sure the same context is used to execute logically related
     * requests.
     */
    ...
    /**
     * Creates a {@link com.github.sardine.model.Propertyupdate} element containing all properties to set from setProps
     * and all properties to remove from removeProps. Note this method will use a
     * {@link com.github.sardine.util.SardineUtil#CUSTOM_NAMESPACE_URI} as namespace and
                ...
                if (r.getPropstat()!=null) {
                    for (Propstat propstat : r.getPropstat()) {
                        if (propstat.getProp()!=null&&propstat.getProp().getResourcetype()!=null
                            ...
                            collections.add(new DavPrincipal(DavPrincipal.PrincipalType.HREF, r.getHref().get(0), propstat.getProp()
                                    .getDisplayname().getContent().get(0)));
                        }
                    }
                }
            }
